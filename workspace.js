...
cprequire_test(["inline:com-chilipeppr-workspace-yg"], function(ws) {
    ...
    $('title').html("Yuske's Workspace for Pendeograph");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-yg", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-yg", // Make the id the same as the cpdefine id
        name: "Workspace / GRBL-Pendeograph", // The descriptive name of your widget.
        desc: `This is a workspace for ChiliPeppr's Hardware Fiddle. It is geared towards Pendeograph drawing machine with GRBL.`,
        ...
        loadWidgets: function(callback) {
            ...
            this.svg2gcodeObj = function() {
                return {
                    ...
                    url: "http://raw.githubusercontent.com/yuskegoto/widget-svg2gcode-yg/master/auto-generated-widget.html",
